...
public class DlgRegistrarItinerario extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        campoTextoNombreItinerario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                campoTextoNombreItinerarioActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addComponent(campoTextoNombreItinerario, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)
    ...
    private void campoTextoNombreItinerarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_campoTextoNombreItinerarioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_campoTextoNombreItinerarioActionPerformed
    ...
    private List<ObjectId> bajarZonas() {
        ...
        for (int i = 0; i < this.cajasZonas.size(); i++) {
            if (cajasZonas.get(i).isSelected()) {
                zonas.add(this.zonas.get(i).getId());
            }
        }
        return zonas;
    }
