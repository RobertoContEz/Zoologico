 ...
 * 
 * Esta clase representa a las distintas especies animales del zoológico. Una
 * abstracción de esta clase contiene todos los datos relevantes de la especie.
...
public class Especie {
     ...
     * @param idsHabitatsDondePuedeVivir lista de los ids de los habitads
     * naturales donde la especie puede vivir
     * @param idZona id de la zona del zoológico en la que se encuentra la
     * especie
     * @param idCuidador id del cuidador que se encarga de la especie
     * @param animales lista de los especimenes animales de la especie presentes
     * en el zoológico
     */
    ...
    /**
     * Devuelve la lista de los ids de los habitads naturales donde la especie
     * puede vivir.
     *
     * @return la lista de los ids de los habitads naturales donde la especie
     * puede vivir
     */
    ...
    /**
     * Establece la lista de los ids de los habitads naturales donde la especie
     * puede vivir
     *
     * @param idsHabitatsDondePuedeVivir la lista de los ids de los habitads
     * naturales donde la especie puede vivir
     */
    ...
    /**
     * Devuelve el id de la zona del zoológico en la que se encuentra la
     * especie.
     *
    ...
    /**
     * Establece el id de la zona del zoológico en la que se encuentra la
     * especie.
     *
     * @param idZona el id de la zona del zoológico en la que se encuentra la
     * especie
     */
    ...
    /**
     * Devuelve la lista de los especimenes animales de la especie presentes en
     * el zoológico.
     *
     * @return la lista de los especimenes animales de la especie presentes en
     * el zoológico
     */
    ...
    /**
     * Establece la lista de los especimenes animales de la especie presentes en
     * el zoológico.
     *
     * @param animales la lista de los especimenes animales de la especie
