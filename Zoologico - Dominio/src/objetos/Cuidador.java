...
/**
 * Esta clase representa a los empleados cuidadores del zoológico.
 * Una abstracción de esta clase contiene todos los datos relevantes del cuidador.
 * En la base de datos, los cuidadores se almacenan en la collección de Empleados.
 */
public class Cuidador extends Empleado{
     ...
     * @param especiesExperto Lista de especies en las que se especializa el cuidador.
     * @param especiesBasicas Lista de especies en las que el cuidador tiene conocimiento básico.
     * @param especiesActuales Lista de especies de las cuales el cuidador está a cargo actualmente.
     * @param listadoDeEspeciesCuidadas Lista de especies que el cuidador ya ha cuidado anteriormente.
     ...
     * @param especiesExperto lista de especies en las que el cuidador es experto.
     */
    ...
    /**
     * Devuelve la lista de especies en las que el cuidador tiene conocimiento básico.
     * @return lista de especies en las que el cuidador tiene conocimiento básico
     */
    ...
    /**
     * Establece la lista de especies en las que el cuidador tiene conocimiento básico.
     * @param especiesBasicas lista de especies en las que el cuidador tiene conocimiento básico
     */
    ...
    /**
     * Devuelve la lista de especies de las cuales el cuidador está a cargo actualmente.
     * @return lista de especies de las cuales el cuidador está a cargo actualmente
     */
    ...
    /**
     * Establece la lista de especies de las cuales el cuidador está a cargo actualmente.
     * @param especiesActuales lista de especies de las cuales el cuidador está a cargo actualmente
     */
    ...
    /**
     * Devuelve el listado de las especies a las que el cuidador ha cuidado anteriormente.
     * @return listado de las especies a las que el cuidador ha cuidado anteriormente
     */
    ...
    /**
     * Establece el listado de las especies a las que el cuidador ha cuidado anteriormente.
     * @param listadoDeEspeciesCuidadas listado de las especies a las que el cuidador ha cuidado anteriormente
     */
